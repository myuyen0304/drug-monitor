...
const validateDrugInput = require("../middlewares/validateDrug"); //import the validation middleware

// Routes for rendering views
// Add the validation middleware to the create and update routes
